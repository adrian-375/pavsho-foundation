...
const projects: Project[] = [
  {
    ...
    tabs: [
      ...
      },
      {
        ...
        content: (
          <p className="text-foreground leading-relaxed">Validated under the Verified Carbon Standard (VCS) framework, ensuring high-integrity carbon accounting, robust monitoring, and independent third-party verification.</p>
        ),
      },
    ],
  },
    ...
    tabs: [
      ...
      },
      {
        ...
        content: (
          <div className="space-y-4 text-foreground leading-relaxed">
            <div>
              <h5 className="font-semibold mb-2">1. Native Mangrove Restoration</h5>
            ...
            <div>
              <h5 className="font-semibold mb-2">2. Hydrological Rehabilitation</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">3. Community-Centered Governance</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">4. Sustainable Livelihood Development</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
    ...
    tabs: [
      {
        label: "Overview",
        content: (
          <p className="text-foreground leading-relaxed">Karnataka's rapidly growing towns and cities present a significant opportunity to modernize municipal solid waste (MSW) systems through an integrated, climate-aligned waste management programme. This project opportunity proposes the development and implementation of scalable waste management solutions across multiple urban local bodies (ULBs), targeting improved collection efficiency, scientific processing, methane reduction, plastic recovery, and circular economy value creation.</p>
        ),
      },
      {
        label: "Project Rationale",
        content: (
          <p className="text-foreground leading-relaxed">Urban centres in Karnataka are experiencing increasing waste generation due to population growth, changing consumption patterns, and urban expansion. A large portion of waste remains inadequately segregated, leading to open dumping, landfill emissions, groundwater contamination, and loss of recyclable value. Organic waste decomposition in unmanaged landfills generates methane, a potent greenhouse gas, while recyclable materials such as plastics are often lost to informal or inefficient systems. This project aims to transition participating cities toward decentralized, resource-efficient, and climate-resilient waste systems.</p>
        ),
      },
      {
        label: "Key Components",
        content: (
          <div className="space-y-4 text-foreground leading-relaxed">
            <div>
              <h5 className="font-semibold mb-2">1. Source Segregation & Collection Systems</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">2. Organic Waste Management</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">3. Plastic Waste Recovery & Recycling</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">4. Scientific Landfill Management</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <div>
              <h5 className="font-semibold mb-2">5. Informal Sector Integration</h5>
              <ul className="list-disc list-inside space-y-1 ml-4">
